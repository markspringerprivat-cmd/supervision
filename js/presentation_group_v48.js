/* Gruppen-V6-Präsentationsrenderer
...
(function(){
  ...
  async function init(){
    ...
    $('exitBtn').onclick = () => { location.href = groupReturnUrl(); };
    ...
    document.addEventListener('keydown', e => { if(e.key === 'ArrowRight' || e.key === ' '){ e.preventDefault(); move(1); } if(e.key === 'ArrowLeft'){ e.preventDefault(); move(-1); } if(e.key === 'Escape'){ location.href=groupReturnUrl(); } });
  }
