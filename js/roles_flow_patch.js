...
(function(){
  ...
  function protocolFields(phase){
    ...
    if(phase===4) return `<section class="card"><h2>Dokumentation: Vertiefte Bearbeitung</h2>${requiredNote('Kriterien für hilfreiche Kritik','sup_p4_kritik')}<div class="perspective-table-entry"><h3>Positive Rückmeldungen</h3><p class="small">Notiere zu jeder Person einen positiven oder nachvollziehbaren Punkt, der von den anderen genannt wurde.</p><div class="three-col">${requiredNote('Positive Rückmeldung zur Schulleitung','sup_p4_pos_sl')}${requiredNote('Positive Rückmeldung zu Lehrkraft A','sup_p4_pos_a')}${requiredNote('Positive Rückmeldung zu Lehrkraft B','sup_p4_pos_b')}</div></div>${requiredNote('Absprachen zum weiteren Vorgehen','sup_p4_absprachen')}</section>`;
...
(function(){
  ...
  function protocolFields(phase){
    ...
    if(phase === 4) return `<section class="card protocol-overview-card"><h2>Dokumentation: Vertiefte Problembearbeitung</h2><p class="small">Halte fest, wie Kritik künftig hilfreich geäußert werden soll und welche konkreten Absprachen entstehen.</p>${reqNote('Kriterien für hilfreiche Kritik','sup_p4_kritik')}${reqNote('Positive Rückmeldungen','sup_p4_pos_sl')}${reqNote('Absprachen zum weiteren Vorgehen','sup_p4_absprachen')}</section>`;
